...
gulp.task('serve', ['styles-replace', 'styles', 'watch'], function () {
  var mw = [
    function (req, res, next) {
      if ((req.url.indexOf('/bower_components') !== 0) && (req.url !== '/') && (req.url !== '/demo/index.html') && (req.url !== '/app-page.html') && (req.url !== '/app-page.js') && (req.url !== '/app-page-styles.html')) {
  ...
  browserSync.init({
    injectChanges: true,
    files: ['./*.{html, scss}', './demo/index.html', './app-page.js', './dist/css/app-page.css'],
    notify: true,
    server: {
      baseDir: "./",
      directory: false,
